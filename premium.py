...
ua=random.choice([
"Mozilla/5.0 (Linux; Android 7.0; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/60.0.3112.107 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]",
"Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]",
"Mozilla/5.0 (Linux; Android 8.1.0; CPH1909) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.93 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/240.0.0.9.115;]"])
ips=None
try:
...
def gagal():
    try:
        ...
        if j in r:
            os.system("clear")
            banner()
            print(k+"\n["+p+"•"+k+"]"+p+" Api Key Confirmed")
            jalan(k+"["+p+"•"+k+"]"+p+" Welcome \x1b[0;32mPremium \x1b[0;37mUser")
            raw_input(k+"\n[ "+p+"Enter"+k+" ]"+p)
            menu()    
        else:
            os.system("clear")
            banner()
            print (k+"\n["+p+"•"+k+"]"+p+" Api Key Not Confirmed")
            print (k+"["+p+"•"+k+"]"+p+" Please Chat Admin For Confirmation")
            print (k+"["+p+"•"+k+"]"+p+" Run Again The Script")
            raw_input(k+"\n[ "+p+"Enter"+k+" ]"+p)
...
def menu():
    ...
    #print(k+"["+p+"•"+k+"]"+p+" Your Api Key : "+open(".api.key").read())
    ...
    print(k+"["+p+"5"+k+"]"+p+" Dump ID By Phone Number")
    print(k+"["+p+"6"+k+"]"+p+" Dump ID By Email")
    print(k+"["+p+"7"+k+"]"+p+" Get Data Target")
    print(k+"["+p+"8"+k+"]"+p+" Start Crack")
...
def publik():
	...
	try:
		...
		print(k+"["+p+"•"+k+"]"+p+" Total ID       : %s"%(len(id)))
                print(k+"\n["+p+"!"+k+"]"+p+" Copy The Output")
		print(k+"["+p+"•"+k+"]"+p+" Output         : %s"%qq)
		raw_input(k+"\n[ "+p+"Back"+k+" ]"+p)
		menu()	
	except Exception as e:
