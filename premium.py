...
def pilihcrack():
  print ("\n[1] Crack Api (Fast Crack)")
  print ("[2] Crack Api (Fast Crack With TTL)")
  print ("[3] Crack Mbasic (Low Crack)")
  print ("[4] Crack Mbasic (Low Crack With TTL)")
  print ("[5] Crack M Facebook (Super Low Crack)")
  krah=raw_input("\n[•] Choose : ")
  if krah in[""]:
    print("[!] Fill In The Correct")
    pilihcrack()
